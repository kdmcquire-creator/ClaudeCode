...
function seedClassificationRules(database: Database.Database): void {
  ...
  seed([
    ...
    ['p10-cond-001','Mon-Thu Restaurant ≥$95','p10_conditional','contains','restaurant','5829',95,null,'1,2,3,4',null,null,'Peak 10','Meals & Meetings - external',null,null,'⚠️ Add attendee names','classify',400,'Mon=1 Tue=2 Wed=3 Thu=4; Monarch category = Restaurants & Bars'],
